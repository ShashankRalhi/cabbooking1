...
<div class="container">
	...
	<div>
		<p style="text-align: center;font-size: 50px;margin-bottom: 20px;">PENDING RIDE</p>
...
?>
		...
		<tr>
			...
			<td>
				...
				<a href="deletependingride.php?id=<?php echo $row['ride_id'];?>" class="deny" style="float:right;">Cancel</a>
			</td>
